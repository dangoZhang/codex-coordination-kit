...
3. Start the right branch/worktree mode for the thread: `thread1` reuses its persistent branch, other producer threads open a fresh scoped branch from the configured base branch.
